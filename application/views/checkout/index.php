        ...
        <!-- col 1-->
			<div class="col-md-6 col-lg-6 col-12">
                ...
                <h4 class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="text-muted">Delivery Details</h5>
                ...
                <div >
                    <form method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="customer_id" value="<?php echo $_SESSION['customer_id']; ?>" readonly>
                        ...
                        <div class="">
                            <input class="btn btn-primary btn-block" type="submit" name="placeOrder" value="Place Order">
                        </div>
                    </form>
                    <br>
                </div>
...
<div class="checkout">
    <div class="row">
        ...
        <!-- Test code  = This is the correct code --> 
        <?php /*
        <div class="col-md-8 order-md-1">
