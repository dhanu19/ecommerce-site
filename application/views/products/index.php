...
<section class="productsDisplay container">
    <h2>PRODUCTS</h2>
        ...
        <!-- List all products --> 
        <div class="row col-lg-12" style=" align-self:center;">
            <?php if(!empty($products)){ foreach($products as $row){ ?>
                <div class="card col-lg-3">
                    <img class="card-img-top" style="height:350px;  background-position: 50% 50%; background-size: cover;" src="<?php echo base_url('uploads/product-images/'.$row['image']); ?>" alt="">
                    <div class="card-body">
